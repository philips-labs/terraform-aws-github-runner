...
module "runners" {
  ...
  instance_minimum_running_time_in_minutes = var.instance_minimum_running_time_in_minutes != null ? var.instance_minimum_running_time_in_minutes : var.minimum_running_time_in_minutes
  ...
  runner_credit_specification              = var.runner_credit_specification
