module "runners" {
  ...
  instance_minimum_running_time_in_minutes = coalesce(each.value.runner_config.instance_minimum_running_time_in_minutes, each.value.runner_config.minimum_running_time_in_minutes)
  ...
  runner_credit_specification              = coalesce(each.value.runner_config.runner_credit_specification, each.value.runner_config.credit_specification)
