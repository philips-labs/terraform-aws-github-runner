...
| <a name="input_credit_specification"></a> [credit\_specification](#input\_credit\_specification) | DEPRECATED - please use runner\_credit\_specification. | `string` | `null` | no |
